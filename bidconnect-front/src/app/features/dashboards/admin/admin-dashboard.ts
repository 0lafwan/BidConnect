      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white/5 border border-white/10 p-6">
            ...
            <p class="text-3xl font-bold text-brutal-accent">156</p>
          </div>
          <div class="bg-white/5 border border-white/10 p-6">
            <h3 class="text-xl font-bold mb-2">Appels d'offres</h3>
            <p class="text-3xl font-bold text-brutal-neon">42</p>
          </div>
          <div class="bg-white/5 border border-white/10 p-6">
            <h3 class="text-xl font-bold mb-2">Soumissions</h3>
            <p class="text-3xl font-bold">289</p>
          </div>
        </div>
